...
# 自転車のVehicleOriginに対する処理
    execute as @e[type=#animated_java:locator_origin, tag=Asset.Actor.Bicycle.Entity.VehicleOrigin] at @s run function asset:actor/bicycle/listener/on_tick/bicycle_locator_origin/vehicle/_
