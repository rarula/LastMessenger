...
#>
# @within function asset:actor/bicycle/listener/on_tick/player/riding/forward/*
...
# 計算用のmarkerを召喚
    ...
    function asset:actor/bicycle/listener/on_tick/player/riding/forward/summon with storage asset:temp Args
...
# Collider.Frontの位置で実行
    execute positioned as @e[type=minecraft:interaction, tag=Asset.Actor.Bicycle.TargetBicycle, tag=Asset.Actor.Bicycle.Entity.Collider.Front] run function asset:actor/bicycle/listener/on_tick/player/riding/positioned_as_collider/_
