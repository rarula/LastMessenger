#> asset:actor/bicycle/listener/on_tick/bicycle_root/at_collider/zero/_
# @within function asset:actor/bicycle/listener/on_tick/bicycle_root/at_collider/edge

#>
# @within function asset:actor/bicycle/listener/on_tick/bicycle_root/at_collider/zero/**
...
# CollisionHeight1 != 0 -> do
    execute unless score #CollisionHeight1 Temp matches 0 run function asset:actor/bicycle/listener/on_tick/bicycle_root/at_collider/zero/do
